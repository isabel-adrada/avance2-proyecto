...
Teniendo en cuenta los resultados de la comprobación de los supuestos, en primera instancia, se observa gráficamente y se identifica a través del coeficiente de correlación lineal de Pearson que hay una relación lineal muy significativa de `r cResearch` entre las variables índice Research y total socore. Por otro lado, la bondad del modelo medida por el coeficiente de determinación es de `r Raj`, valor que brinda una alta confiabilidad a las predicciones del modelo, indicando que el `r rp`\% de la variabilidad de las predicciones de Total Score pueden ser explicadas con el modelo de regresión con la variable Research. Finalmente debido al cumplimiento de los supuestos probado anteriormente, puede considerarse fiable pronosticar con el modelo construido.
